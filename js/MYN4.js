$(document).ready(function () {
  ...
  $('form').on('submit', function (event) {
    ...
    const g4 = +(1 / (+$("#R4").val() + +$("#r4").val())).toFixed(2)
    ...
    const U = ((E1 * g1 + E2 * g2 + E3 * g3 + E4 * g4) / (g1 + g2 + g3 + g4)).toFixed(2)

    //ток для каждой ветви
    const I1 = ((E1 - U) * g1).toFixed(2)
    const I2 = ((E2 - U) * g2).toFixed(2)
    const I3 = ((E3 - U) * g3).toFixed(2)
    const I4 = ((E4 - U) * g4).toFixed(2)

    ids1 = ['R1', 'R2', 'R3', 'R4', 'r1', 'r2', 'r3', 'r4']
    ids2 = {'g1': g1, 'g2': g2, 'g3': g3, 'g4': g4, 'E1': E1, 'E2': E2, 'E3': E3, 'E4': E4, 'U': U, 'I1': I1, 'I2': I2, 'I3': I3, 'I4': I4}
    for (i in ids1) {
      myInnerHTML(ids1[i])
    }
    for (key in ids2) {
